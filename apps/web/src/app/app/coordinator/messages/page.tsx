...
/**
 * Coordinator · Messages — cross-case inbox (M7.7).
 *
 * Lists every case at the facility with the most-recent message on top.
 * Click into a case to see the full thread on the admin case-detail.
 */
  ...
  return (
    <AppShell breadcrumbs={['Coordinator', 'Messages']}>
      ...
      {!messages ? (
        ...
        <div className="card"><div className="muted">No messages on any case yet.</div></div>
      ) : (
